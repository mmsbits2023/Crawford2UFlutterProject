import 'dart:convert';
import 'package:crawford2u/Pages/client/client_details.dart';
import 'package:crawford2u/Pages/client/sign_up_page.dart';
                      ...
                      child: Center(
                        child: GestureDetector(
                          onTap: () {
                            ...
                            loginUser();// You can add logic here to navigate to the next screen after successful login
                          },
                          child: Text(
                            "Log In",
                            style: TextStyle(
